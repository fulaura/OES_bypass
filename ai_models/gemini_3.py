...
# Allow running this file directly: `python ai_models/gemini_3.py`
...
def generate(
	...
	*,
	...
	generate_content_config = types.GenerateContentConfig(
		...
		response_schema=resp_schema["list_obj"],
...
def main(argv: list[str] | None = None) -> int:
	parser = argparse.ArgumentParser(description="Test runner for ai_models.gemini_3")
	parser.add_argument(
		"--prompt",
	...
	parser.add_argument(
		"--thinking-level",
		help="Thinking level (e.g. NONE, LOW, MEDIUM, HIGH).",
		default="MEDIUM",
	)
	parser.add_argument(
		"--no-google-search",
